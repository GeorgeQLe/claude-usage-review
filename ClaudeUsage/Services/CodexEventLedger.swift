...
class CodexEventLedger {
    ...
    private var fileURL: URL {
        directory.appendingPathComponent("codex-events.jsonl")
    }
    ...
    func readEvents() throws -> [CodexInvocationEvent] {
        ...
        return lines.compactMap { line in
            ...
            return try? decoder.decode(CodexInvocationEvent.self, from: data)
        }
    }
