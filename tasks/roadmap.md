...
| 5 | Accuracy Mode wrappers | Complete: explicit opt-in Codex/Gemini wrappers, setup verification, event ledgers, confidence upgrades, and privacy guarantees |
| 6 | Migration, diagnostics, packaging | Complete: non-secret migration, diagnostics export, Windows/Linux packaging config, and final regression gates |
